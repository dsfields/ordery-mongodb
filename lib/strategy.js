 ...
 * Optional data used to control ordery conversion behavior.
 *
 * @prop {string[]} [allow]
 * @prop {string[]} [deny]
 * @prop {object} [require]
 * @prop {string[]} require.fields
 * @prop {'any'|'all'} which=anya
 */


/**
 * A class that represents a converstion stratgy. Instances are meant to be
...
class Strategy {
  ...
  assertAllowed(target) {
    ...
    const exists = this._list.indexOf(target.value) > -1;
